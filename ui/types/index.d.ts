declare module "components/button/button.vue" {
    ...
    const __VLS_component: import("vue").DefineComponent<ButtonProps, {}, {}, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, {}, string, import("vue").PublicProps, Readonly<ButtonProps> & Readonly<{}>, {
        type: "primary" | "secondary" | "default";
        text: string;
        disabled: boolean;
...
declare module "index" {
    import { App } from "vue";
    export function install(app: App, namePre?: string): void;
}
